...
func INSMETHOD_GetAllMigrationDaemon(object []byte, data []byte) ([]byte, []byte, error) {
	...
	if len(object) == 0 {
		return nil, nil, &ExtendableError{S: "[ FakeGetAllMigrationDaemon ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
	}

	err := ph.Deserialize(object, self)
	if err != nil {
		e := &ExtendableError{S: "[ FakeGetAllMigrationDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return nil, nil, e
	}
	...
	if err != nil {
		e := &ExtendableError{S: "[ FakeGetAllMigrationDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return nil, nil, e
	}
...
func INSMETHOD_ActivateDaemon(object []byte, data []byte) ([]byte, []byte, error) {
	...
	if len(object) == 0 {
		return nil, nil, &ExtendableError{S: "[ FakeActivateDaemon ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
	}

	err := ph.Deserialize(object, self)
	if err != nil {
		e := &ExtendableError{S: "[ FakeActivateDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return nil, nil, e
	}
	...
	err = ph.Deserialize(data, &args)
	if err != nil {
		e := &ExtendableError{S: "[ FakeActivateDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return nil, nil, e
	}
...
func INSMETHOD_DeactivateDaemon(object []byte, data []byte) ([]byte, []byte, error) {
	...
	if len(object) == 0 {
		return nil, nil, &ExtendableError{S: "[ FakeDeactivateDaemon ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
	}

	err := ph.Deserialize(object, self)
	if err != nil {
		e := &ExtendableError{S: "[ FakeDeactivateDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return nil, nil, e
	}
	...
	err = ph.Deserialize(data, &args)
	if err != nil {
		e := &ExtendableError{S: "[ FakeDeactivateDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return nil, nil, e
	}
...
func INSMETHOD_CheckActiveDaemon(object []byte, data []byte) ([]byte, []byte, error) {
	...
	if len(object) == 0 {
		return nil, nil, &ExtendableError{S: "[ FakeCheckActiveDaemon ] ( INSMETHOD_* ) ( Generated Method ) Object is nil"}
	}

	err := ph.Deserialize(object, self)
	if err != nil {
		e := &ExtendableError{S: "[ FakeCheckActiveDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Data: " + err.Error()}
		return nil, nil, e
	}
	...
	err = ph.Deserialize(data, &args)
	if err != nil {
		e := &ExtendableError{S: "[ FakeCheckActiveDaemon ] ( INSMETHOD_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return nil, nil, e
	}
...
func INSCONSTRUCTOR_NewMigrationAdmin(data []byte) ([]byte, []byte, error) {
	...
	err := ph.Deserialize(data, &args)
	if err != nil {
		e := &ExtendableError{S: "[ FakeNewMigrationAdmin ] ( INSCONSTRUCTOR_* ) ( Generated Method ) Can't deserialize args.Arguments: " + err.Error()}
		return nil, nil, e
	}
